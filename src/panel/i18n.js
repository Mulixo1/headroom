...
const dict = {
  en: {
    htmlLang: "en",
    title: "Headroom",
    brandSub: "GPT · x · Cursor Auto · Cursor API · remaining",
    healthOnline: "online",
    healthOffline: "offline",
    refresh: "Refresh",
    syncMenubar: "Write to menubar",
    accountsTitle: "Accounts",
    accountsDesc: "Plug and play: GPT, x, Cursor Auto, and Cursor API load automatically. Choose bar / detail visibility here.",
    ...
    gptX: "GPT · x · Cursor Auto · Cursor API",
    lowest: "Lowest",
    priority: "priority",
  ...
  tr: {
    htmlLang: "tr",
    title: "Headroom",
    brandSub: "GPT · x · Cursor Auto · Cursor API · kalan limit",
    healthOnline: "online",
    healthOffline: "offline",
    refresh: "Yenile",
    syncMenubar: "Menubar’a yaz",
    accountsTitle: "Hesaplar",
    accountsDesc: "Tak-çalıştır: GPT, x, Cursor Auto ve Cursor API otomatik. Bar / detay görünümünü buradan yönet.",
